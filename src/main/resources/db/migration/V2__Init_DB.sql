...
INSERT INTO users (id, created, email, first_name,
                   ...
                   phone_number,
                   specialization, study_format)
VALUES (2, current_timestamp, 'instructor@gmail.com', 'instructor', TRUE, 'instructor', 'instructor', null, null, null)
ON CONFLICT do nothing;
...
INSERT INTO users (id, created, email, first_name,
                   ...
                   phone_number,
                   specialization, study_format)
VALUES (3, current_timestamp, 'student@gmail.com', 'student', TRUE, 'student', 'student', null, null, null)
ON CONFLICT do nothing;
